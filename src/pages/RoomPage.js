...
const RoomPage = () => {
    ...
    // Función para formatear solo la hora (HH:MM AM/PM)
    const formatTime = (timeString) => {
        if (!timeString) return "Horario no disponible";
        
        try {
            // Si es un string de hora directo (ej: "20:00:00")
            ...
            // Si es una fecha ISO (para compatibilidad)
                        ...
                        <Box sx={{ mb: 4 }}>
                            ...
                            <Box sx={{ 
                                ...
                                <Box>
                                    ...
                                    <Typography variant="body1" sx={{ fontWeight: 500 }}>
                                        {formatTime(room.hour)} {/* Cambiado de schedule a hour */}
                                    </Typography>
                                </Box>
